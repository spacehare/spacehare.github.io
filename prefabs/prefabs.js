...
function gv(compiledOutput) {
    compiledOutput.forEach((o) => {
        const title = document.createElement("h3");
        title.innerText = o.folder_name;
        title.className = "folder_name";
        main === null || main === void 0 ? void 0 : main.appendChild(title);
        ...
        o.files.forEach((f) => {
            ...
            awaga === null || awaga === void 0 ? void 0 : awaga.appendChild(button);
        });
        main === null || main === void 0 ? void 0 : main.appendChild(awaga);
    });
}
